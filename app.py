...
def analyze_text_emotion(text, target_language="en"):
    ...
    neutral_index = list(labels.values()).index('neutral')
    joy_index = list(labels.values()).index('joy')
    probabilities[0, joy_index] += probabilities[0, neutral_index]
    probabilities[0, neutral_index] = 0
